...
"""
parser.add_argument('--train_data', type=str, default='../data/java2c/train.json',
                    help='training data')
parser.add_argument('--val_data', type=str, default='../data/java2c/jgit-data.json',
                    help='training data')
parser.add_argument('--test_data', type=str, default='../data/java2c/antlr-data.json',
                    help='test data')
"""
